...
enum DestinationRegistry {
    static let all: [Destination] = [
        ...
        Destination(key: "notifications", title: "Notifications", systemImage: "bell", group: .main, permission: nil, isBuilt: false, blurb: nil),
        ...
        Destination(key: "orders", title: "Web Orders", systemImage: "cart", group: .operations, permission: "orders.manage", isBuilt: false, blurb: nil),
        ...
        Destination(key: "tireAttributes", title: "Tire Attributes", systemImage: "gearshape", group: .operations, permission: "inventory.config", isBuilt: false, blurb: nil),
        Destination(key: "brandInfo", title: "Brand Info", systemImage: "book", group: .operations, permission: "brands.manage", isBuilt: false, blurb: nil),
        ...
        Destination(key: "monthlySales", title: "Monthly Sales", systemImage: "square.grid.2x2", group: .finance, permission: "accounting.view", isBuilt: false, blurb: nil),
